...
# Для проверки согласованности мы использовали метод Колмогорова, потому что он основан на сравнении эмпирической функции распределения выборки с теоретической функцией распределения.
